...
var GGBApplet = function () {
    ...
    var setDefaultHTML5CodebaseForVersion = function (version, offline) {
        ...
        if (index > 0) {
            ...
            codebase = "https://www.geogebra.org/apps/5.0.636.0/"
        }
...
GGBAppletUtils.makeModule = function (name, permutation) {
    function webModule() {
        ...
        B();
        webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.636.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
    web3d = GGBAppletUtils.makeModule("web3d", "458A5362EEEC13BBBBCB29947E2B34DF")
}
if (typeof window.webSimple !== "function") {
    webSimple = GGBAppletUtils.makeModule("webSimple", "B1FE546C4E95B874AA487DC9B71C0F7B")
}